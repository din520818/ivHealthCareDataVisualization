...
import logo from "../../assets/images/Flag_of_Nepal.gif";
      ...
      <Menu theme="light" mode="inline">
        ...
        <Menu.Item key="4">
          <NavLink to="/rtl">
            ...
            <span className="label">Outbreaks</span>
          </NavLink>
        </Menu.Item>
        ...
        <Menu.Item key="8">
          <NavLink to="/sign-up">
            ...
            <span className="label">Create A New Account</span>
          </NavLink>
        </Menu.Item>
      </Menu>
